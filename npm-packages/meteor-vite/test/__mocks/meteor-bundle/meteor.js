...
/* Package-scope variables */
  ...
  (function () {
    ...
    const PRp = PackageRegistry.prototype
      ...
      return function (...fnArgs) {
        return new Promise((resolve, reject) => {
          const callback = Meteor.bindEnvironment((error, result) => {
            let _error = error; let _result = result
            if (!errorFirst) {
              _error = result
              _result = error
            }
  ...
  (function () {
    ...
    Meteor.makeErrorType = function (name, constructor) {
      const errorClass = function (/* arguments */) {
  ...
  (function () {
    ...
    Meteor.startup = function (callback) {
      ...
      const doScroll = !document.addEventListener
  ...
  (function () {
    ...
    const testDriverPackageName = TEST_METADATA.driverPackage
      ...
      Meteor.startup(() => {
        ...
        if (Meteor.isClient) {
          if (typeof testDriverPackage.runTests !== 'function') {
            throw new TypeError(`Test driver package ${testDriverPackageName
  ...
  (function () {
    ...
    Meteor.absoluteUrl = function (path, options) {
      ...
      // to localhost.
      if (options.secure
      && url.startsWith('http:') // url starts with 'http:'
