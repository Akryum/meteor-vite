...
import type { ModuleList, PackageScopeExports } from '../../src/meteor/package/Parser'
...
export const AutoImportMock = new class {
  ...
  public async useEntrypoint({ testName, entrypoint }: { testName: string; entrypoint: keyof typeof AutoImportMock.entrypoints }) {
