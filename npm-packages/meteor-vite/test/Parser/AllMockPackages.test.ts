...
import type { ModuleExport } from '../../src/meteor/package/Parser'
import { parseMeteorPackage } from '../../src/meteor/package/Parser'
          ...
          describe(filePath, () => {
            ...
            describe.runIf(mockReExports?.length)('Re-exports', () => {
              mockReExports?.forEach((mockExport) => {
                it(Serialize.moduleExport(mockExport, mockPackage.packageName), ({ expect }) => {
